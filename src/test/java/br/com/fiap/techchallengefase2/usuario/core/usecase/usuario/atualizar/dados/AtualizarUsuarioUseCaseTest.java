package br.com.fiap.techchallengefase2.usuario.core.usecase.usuario.atualizar.dados;
...
class AtualizarUsuarioUseCaseTest {
    ...
    void deveLancarExcecaoQuandoEmailJaExistir() {
        ...
        when(buscarUsuarioPorIdUseCase.buscarPorId(usuarioLogadoId)).thenReturn(usuarioAtual);
        when(usuarioGateway.existeUsuarioComEmail(dadosUsuarioInputDTO.getEmail())).thenReturn(true);
